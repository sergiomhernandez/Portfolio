    ...
    <div name="home">
        <header className='flex h-screen w-full items-center justify-center bg-cover bg-center bg-no-repeat' style={{backgroundImage: `url(${Background})` }}>
            ...
            <section className='block z-[1] relative text-center'>
                ...
                <div>
                    <Link to='portfolio' smooth duration={500} className='border-2 py-[16px] px-[32px] rounded-[99px] uppercase tracking-[0.125em] border-cyan-200 bg-transparent text-cyan-200 hover:bg-cyan-200 hover:text-white duration-300 ease-in-out text-[14px] w-56 flex items-center justify-center mx-auto my-0'>Portfolio 
